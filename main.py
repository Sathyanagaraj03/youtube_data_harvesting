...
api_key="AIzaSyBQYFRDBDuClwq0IvMeeFZsRarj7cIt3zU"#Youtube_API_V3
...
engine = create_engine("mysql+mysqlconnector://root:""@localhost/guvi_ds")
channel_details =[]
upload_ids = []
video_ids = []
video_details=[]
...
def channel_data_to_mydatabase(channel_ids):
...
def sql_comment_data_table():
    ...
    channel_details.to_sql(name='channel_detail', con=engine, if_exists='append', index=False)
...
def streamlit_channel_details(): 
    df = st.dataframe(channel_details)
...
#.............................................. Streamlit Main Page ............................................................#
    ...
    channel_data_to_mydatabase(channel_ids)
    ...
    st.subheader("Step 2: Store  Data to SQL")

    st.markdown('<p style="color: red;">🔽 <strong>Click me to store Data to SQL</strong></p>', unsafe_allow_html=True)


    if st.button("Store Data to SQL Database"):
        # Create a spinner to show loading animation
        with st.spinner("Storing data to SQL..."):
            # Simulate SQL migration
            display = sql_tables()
        
        # Display a success message after the spinner
        st.success("Data Stored to SQL Database completed successfully!")
        st.success(display)
